...
/** Pattern waveform -> normalized 0..1 envelope at the given phase. Deterministic (no RNG). Exported for tests. */
export function waveform(name, phase, profile) {
...
export const liftSpin = (v) => (v > MIN_SPIN_LIFT && v < BLE.MOTOR_MIN_SPIN ? BLE.MOTOR_MIN_SPIN : (v <= MIN_SPIN_LIFT ? 0 : v));
