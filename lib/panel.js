...
#haptix-launch {
    ...
    background:transparent; animation:htxBob 2.8s ease-in-out infinite;
}
...
function injectStyles() {
    ...
    // Keep the legacy stylesheet too for any external CSS overrides users may have.
    if (!document.getElementById('haptix-style')) {
        try {
